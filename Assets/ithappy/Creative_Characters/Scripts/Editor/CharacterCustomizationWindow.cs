...
using ithappy.Creative_Characters.CharacterCustomizationTool.Editor.FaceEditor;
using ithappy.Creative_Characters.CharacterCustomizationTool.Editor.MaterialManagement;
using ithappy.Creative_Characters.Controller;
using UnityEditor;
using UnityEditor.Animations;
using UnityEngine;

namespace ithappy.Creative_Characters.CharacterCustomizationTool.Editor
{
    public class CharacterCustomizationWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/ithappy/Creative_Characters/Character Customization")]
